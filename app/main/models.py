...
class Product(models.Model):
    ...
    category = models.OneToOneField(CategoryProduct, on_delete=models.CASCADE, verbose_name='Категория продукта', null=True)
    bank = models.OneToOneField(Bank, on_delete=models.CASCADE, verbose_name='Банк', null=True)
